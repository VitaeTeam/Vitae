...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1595992831, // * UNIX timestamp of last checkpoint block
    4834332,     // * total number of transactions between genesis and last checkpoint
...
public:
    CTestNetParams()
    {
        ...
        nRejectOldSporkKey = 1598918400; //!> Reject old spork key after September 1, 2020 12:00:00 AM GMT
