...
public:
    CMainParams()
    {
        ...
        consensus.nEnforceBlockUpgradeMajority = 10800; // 75%
        consensus.nRejectBlockOutdatedMajority = 13680; // 95%
        consensus.nToCheckBlockUpgradeMajority = 14400; // Approximate expected amount of blocks in 7 days (1440*7.5)
        ...
        consensus.height_start_ZC = 209467;
