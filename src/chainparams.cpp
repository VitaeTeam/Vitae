...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("41e482b9b9691d98eefb48473405c0b8ec31b76df3797c74a78680ef818"))
    (191884, uint256S("45b95a52b673fd9f620bed8d59c5cfb05db0ffc33225bc6778b08d251348b185"))
    (204305, uint256S("101cfe17653d7b5ea6bb15531d9344dd65837f96904599ebc054bc8f6fad355d")) //about when spork 15 activated
    (204464, uint256S("9d2f9808c10408899cfff44f6a3adc44690912dd0dcb3b530c45cd2ad9a31f0e")) //about when spork 16 activated
    (369647, uint256S("82ba21a1afcb59ebdede612516d9c3bfed42e2e18baba172b971fd714d32bdf6"));
...
public:
    CMainParams()
    {
        ...
        consensus.height_start_ZC = 209467;                 // Block v4: 5b2482eca24caf2a46bb22e0545db7b7037282733faa3a42ec20542509999a64
        ...
        consensus.height_start_ZC_SerialsV2 = 99999999;
        consensus.height_ZC_RecalcAccumulators = 908000;

        // validation by-pass
        consensus.nVitaeBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nVitaeBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.ZC_TimeStart = 1536314400; // september 7, 2018 12:00:00 UTC
...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.nVitaeBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nVitaeBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
