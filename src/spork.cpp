...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_28_NEW_STAKE_MIN_DEPTH_BLOCK) r = SPORK_28_NEW_STAKE_MIN_DEPTH_BLOCK_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_28_NEW_STAKE_MIN_DEPTH_BLOCK") return SPORK_28_NEW_STAKE_MIN_DEPTH_BLOCK;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_28_NEW_STAKE_MIN_DEPTH_BLOCK) return "SPORK_28_NEW_STAKE_MIN_DEPTH_BLOCK";
