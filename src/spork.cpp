...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_NEW_PROTOCOL_ENFORCEMENT_3_MODE) r = SPORK_16_NEW_PROTOCOL_ENFORCEMENT_3_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_16_NEW_PROTOCOL_ENFORCEMENT_3") return SPORK_16__NEW_PROTOCOL_ENFORCEMENT_3_MODE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_16__NEW_PROTOCOL_ENFORCEMENT_3_MODE) return "SPORK_NEW_PROTOCOL_ENFORCEMENT_3_MODE";
