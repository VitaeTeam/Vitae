...
BOOST_AUTO_TEST_CASE(rpc_ban)
{
    ...
    // 1924841572 is year 2030. Any time before now will cause subsequent tests fail
    BOOST_CHECK_NO_THROW(r = CallRPC(string("setban 127.0.0.0/24 add 1924841572 true")));
    BOOST_CHECK_NO_THROW(r = CallRPC(string("listbanned")));
    ar = r.get_array();
    o1 = ar[0].get_obj();
    ...
    BOOST_CHECK_EQUAL(banned_until.get_int64(), 1924841572); // absolute time check
