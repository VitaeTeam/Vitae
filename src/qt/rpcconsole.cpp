                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzVITAEPathCustom = GetArg("zvitbackuppath", "");
    ...
    if(!strzVITAEPathCustom.empty()) {
        ui->wallet_customzvitbackuppath->setText(QString::fromStdString(strzVITAEPathCustom));
        ui->wallet_customzvitbackuppath_label->setVisible(true);
        ui->wallet_customzvitbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzVITAEPathCustom.empty()) && nCustomBackupThreshold > 0) {
