...
#ifndef VITAE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define VITAE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //VITAE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
