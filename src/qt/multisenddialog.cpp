...
void MultiSendDialog::on_viewButton_clicked()
{
    ...
    if (pwalletMain->isMultiSendEnabled()) {
        if (pwalletMain->fMultiSendStake && pwalletMain->fMultiSendMasternodeReward && pwalletMain->fMultiSendFundamentalnodeReward)
            strStatus += tr("MultiSend Active for Stake, Masternode, and Fundamentalnode Rewards") + "\n";
            ...
            strStatus += tr("MultiSend Active for Stakes and Fundamentalnode Rewards") + "\n";
        else if (pwalletMain->fMultiSendFundamentalnodeReward && pwalletMain->fMultiSendMasternodeReward)
            strStatus += tr("MultiSend Active for Fundamentalnode and Masternode Rewards") + "\n";
            ...
            strStatus += tr("MultiSend Active for Fundamentalnode Rewards") + "\n";
