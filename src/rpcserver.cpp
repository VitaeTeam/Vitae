...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"vitae", "listmasternodes", &listmasternodes, true, true, false},
        {"vitae", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vitae", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vitae", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vitae", "masternodedebug", &masternodedebug, true, true, false},
        {"vitae", "startmasternode", &startmasternode, true, true, false},
        {"vitae", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vitae", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vitae", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vitae", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vitae", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vitae", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vitae", "mnbudget", &mnbudget, true, true, false},
        {"vitae", "preparebudget", &preparebudget, true, true, false},
        {"vitae", "submitbudget", &submitbudget, true, true, false},
        {"vitae", "mnbudgetvote", &mnbudgetvote, true, true, false},
        ...
        {"vitae", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vitae", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vitae", "checkbudgets", &checkbudgets, true, true, false},
        {"vitae", "mnsync", &mnsync, true, true, false},
