Contributing to VITAE Core
============================

The VITAE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VITAE Core project, and is not to be
confused with overall VITAE Network Protocol consensus changes.

Whether a pull request is merged into VITAE Core rests with the project merge
...
The project leader is the release manager for each VITAE Core release.
