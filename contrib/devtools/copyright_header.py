...
// Copyright (c) <firstYear>-<lastYear> The VITAE developers

will be updated to:

// Copyright (c) <firstYear>-<lastModifiedYear> The VITAE developers

where <lastModifiedYear> is obtained from the 'git log' history.

This subcommand also handles copyright headers that have only a single year. In those cases:

// Copyright (c) <year> The VITAE developers

will be updated to:

// Copyright (c) <year>-<lastModifiedYear> The VITAE developers
...
Arguments:
    <base_directory> - The base directory of a vitae source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The VITAE developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The VITAE developers'
                 % (filename))
