...
In order to support loading of multiple wallets in vitae-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vitae.cpp.
...
Changes to vitae.cpp
----------------------
vitae.cpp is the entry point into vitae-qt, and as such, will require some minor modifications to provide hooks for
