UNIX BUILD NOTES
====================
Some notes on how to build VITAE Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile VITAE Core and the dependencies,
...
memory available when compiling VITAE Core. On systems with less, gcc can be
...
To build VITAE Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
If you want to build vitae-qt, make sure that the required packages for Qt development
...
Security
--------
To help make your VITAE Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, VITAE Core should be built with a non-executable stack
